...
/**
 * Reusable modal for adding/editing a team.
 * @param {object} props
 ...
 */
export default function TeamModal({ open, onClose, onSubmit, initialValues = {}, mode = 'add' }) {
  ...
  const validate = () => {
    const errs = {};
    if (!name.trim()) errs.name = t('teamNameRequired');
    return errs;
  };
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
      <DialogTitle>{mode === 'edit' ? t('editTeam') : t('addTeam')}</DialogTitle>
